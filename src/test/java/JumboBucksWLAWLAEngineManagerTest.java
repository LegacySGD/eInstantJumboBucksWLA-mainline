...
public class JumboBucksWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(JumboBucksWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/JumboBucksWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/JumboBucksWLAIW/InitOutcome.xml").getDocumentElement();
